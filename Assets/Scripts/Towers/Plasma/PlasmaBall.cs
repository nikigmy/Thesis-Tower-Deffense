...
public class PlasmaBall : Projectile {
    ...
    {
        Instantiate(explosionPrefab, targetPosition, Quaternion.identity).transform.localScale = new Vector3(explosionRange * 0.8f, explosionRange * 0.8f, explosionRange * 0.8f);
